...
const navigation = [
  ...
  { name: 'Post', href: '/create-post', current: false },
];
              ...
              <div className="relative z-10 px-2 flex lg:px-0">
                <div className="flex-shrink-0 flex items-center">
                  <img
                    ...
                    src="https://upload.wikimedia.org/wikipedia/commons/thumb/3/3e/Instagram_simple_icon.svg/1920px-Instagram_simple_icon.svg.png"
                    alt="Instagram Clone"
                  />
                </div>
              </div>
